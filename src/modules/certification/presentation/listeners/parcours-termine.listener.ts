...
export class ParcoursTermineListener {
  ...
  // ✅ FIX: Changed 'learningPath.completed' to 'LearningPathCompletedEvent'
  // to match the class constructor name emitted in your test.
  // eslint-disable-next-line @typescript-eslint/no-unsafe-call
  @OnEvent('LearningPathCompletedEvent')
  async handleEvent(
    payload: LearningPathCompletedIntegrationEvent,
  ): Promise<void> { 
    console.log("💡 [Listener BC5] Évènement reçu dans le module Certification !", payload.targetCertificationId); 
